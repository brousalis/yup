...
var _objectWithoutPropertiesLoose2 = _interopRequireDefault(
  require('@babel/runtime/helpers/builtin/objectWithoutPropertiesLoose'),
);
...
function resolveParams(oldParams, newParams, resolve) {
  return (0, _mapValues.default)(
    (0, _extends2.default)({}, oldParams, newParams),
    resolve,
  );
}
...
function createErrorFactory(_ref) {
  var value = _ref.value,
    ...
    opts = (0, _objectWithoutPropertiesLoose2.default)(_ref, [
      'value',
      'label',
      'resolve',
      'originalValue',
...
function createValidation(options) {
  ...
  function validate(_ref3) {
    var value = _ref3.value,
      ...
      sync = _ref3.sync,
      rest = (0, _objectWithoutPropertiesLoose2.default)(_ref3, [
        'value',
        'path',
        'label',
        'options',
    ...
    var resolve = function resolve(value) {
      return _Reference.default.isRef(value)
    ...
    return runTest(test, ctx, value, sync).then(function(validOrError) {
      if (_ValidationError.default.isError(validOrError)) throw validOrError;
