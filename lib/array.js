...
var _taggedTemplateLiteralLoose2 = _interopRequireDefault(
  require('@babel/runtime/helpers/builtin/taggedTemplateLiteralLoose'),
);
...
(0, _inherits.default)(ArraySchema, _mixed.default, {
  ...
  _validate: function _validate(_value, options) {
    ...
    return _mixed.default.prototype._validate
      .call(this, _value, options)
      .catch((0, _runValidations.propagateErrors)(endEarly, errors))
      .then(function(value) {
  ...
  of: function of(schema) {
    var next = this.clone();
    if (schema !== false && !(0, _isSchema.default)(schema))
      throw new TypeError(
  ...
  min: function min(_min, message) {
    ...
    return this.test({
      ...
      test: function test(value) {
        return (
          (0, _isAbsent.default)(value) || value.length >= this.resolve(_min)
        );
      },
    });
  },
  max: function max(_max, message) {
    ...
    return this.test({
      ...
      test: function test(value) {
        return (
          (0, _isAbsent.default)(value) || value.length <= this.resolve(_max)
        );
      },
    });
  },
